...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const generalType = yield (0, cli_1.selectFromOptions)(
      "Select the framework, project or tool type",
      mappings_1.cliOptions[filter]
    );
    ...
    const editorType = yield (0, cli_1.selectFromOptions)(
      "Select the Editor type",
      mappings_1.editorOptions[editorFilter]
    );
